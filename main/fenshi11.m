function varargout = fenshi11(varargin)
% fenshi11 MATLAB code for fenshi11.fig
%      fenshi11, by itself, creates a new fenshi11 or raises the existing
%      singleton*.
%
%      H = fenshi11 returns the handle to a new fenshi11 or the handle to
%      the existing singleton*.
%
%      fenshi11('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in fenshi11.M with the given input arguments.
%
%      fenshi11('Property','Value',...) creates a new fenshi11 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before fenshi11_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to fenshi11_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help fenshi11

% Last Modified by GUIDE v2.5 02-May-2020 10:16:36

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @fenshi11_OpeningFcn, ...
                   'gui_OutputFcn',  @fenshi11_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before fenshi11 is made visible.
function fenshi11_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to fenshi11 (see VARARGIN)

% Choose default command line output for fenshi11
set(gcf,'numbertitle','off','name','停车场地费用等其他费用');
...
% UIWAIT makes fenshi11 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = fenshi11_OutputFcn(hObject, eventdata, handles) 
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
set(handles.edit1,'string','3000');
set(handles.edit2,'string','3000');
set(handles.edit3,'string','3000');
set(handles.edit4,'string','3000');
set(handles.edit5,'string','3000');
set(handles.edit6,'string','3000');
set(handles.edit7,'string','3000');
set(handles.edit8,'string','3000');
set(handles.edit9,'string','3000');
set(handles.edit10,'string','3000');
set(handles.edit11,'string','3000');
set(handles.edit12,'string','3000');
set(handles.edit13,'string','3000');
set(handles.edit14,'string','3000');
set(handles.edit15,'string','3000');
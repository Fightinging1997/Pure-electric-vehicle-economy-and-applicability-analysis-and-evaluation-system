function varargout = cost11(varargin)
% cost11 MATLAB code for cost11.fig
%      cost11, by itself, creates a new cost11 or raises the existing
%      singleton*.
%
%      H = cost11 returns the handle to a new cost11 or the handle to
%      the existing singleton*.
%
%      cost11('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in cost11.M with the given input arguments.
%
%      cost11('Property','Value',...) creates a new cost11 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before cost11_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to cost11_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help cost11

% Last Modified by GUIDE v2.5 02-May-2020 12:52:48

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @cost11_OpeningFcn, ...
                   'gui_OutputFcn',  @cost11_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before cost11 is made visible.
function cost11_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to cost11 (see VARARGIN)

% Choose default command line output for cost11
set(gcf,'numbertitle','off','name','其他费用');
...
% UIWAIT makes cost11 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = cost11_OutputFcn(hObject, eventdata, handles) 

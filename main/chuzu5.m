function varargout = chuzu5(varargin)
% chuzu5 MATLAB code for chuzu5.fig
%      chuzu5, by itself, creates a new chuzu5 or raises the existing
%      singleton*.
%
%      H = chuzu5 returns the handle to a new chuzu5 or the handle to
%      the existing singleton*.
%
%      chuzu5('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in chuzu5.M with the given input arguments.
%
%      chuzu5('Property','Value',...) creates a new chuzu5 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before chuzu5_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to chuzu5_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help chuzu5

% Last Modified by GUIDE v2.5 01-May-2020 23:32:37

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @chuzu5_OpeningFcn, ...
                   'gui_OutputFcn',  @chuzu5_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before chuzu5 is made visible.
function chuzu5_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to chuzu5 (see VARARGIN)

set(gcf,'numbertitle','off','name','维修和保养费用');
% Choose default command line output for chuzu5
...
% UIWAIT makes chuzu5 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = chuzu5_OutputFcn(hObject, eventdata, handles) 

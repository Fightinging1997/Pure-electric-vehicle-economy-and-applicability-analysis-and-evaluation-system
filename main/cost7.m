function varargout = cost7(varargin)
% cost7 MATLAB code for cost7.fig
%      cost7, by itself, creates a new cost7 or raises the existing
%      singleton*.
%
%      H = cost7 returns the handle to a new cost7 or the handle to
%      the existing singleton*.
%
%      cost7('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in cost7.M with the given input arguments.
%
%      cost7('Property','Value',...) creates a new cost7 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before cost7_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to cost7_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help cost7

% Last Modified by GUIDE v2.5 02-May-2020 12:49:06

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @cost7_OpeningFcn, ...
                   'gui_OutputFcn',  @cost7_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before cost7 is made visible.
function cost7_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to cost7 (see VARARGIN)
set(gcf,'numbertitle','off','name','充电桩维护或运营费用');
% Choose default command line output for cost7
...
% UIWAIT makes cost7 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = cost7_OutputFcn(hObject, eventdata, handles) 

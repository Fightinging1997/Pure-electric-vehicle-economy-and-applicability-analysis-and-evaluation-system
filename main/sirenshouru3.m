function varargout = sirenshouru3(varargin)
% sirenshouru3 MATLAB code for sirenshouru3.fig
%      sirenshouru3, by itself, creates a new sirenshouru3 or raises the existing
%      singleton*.
%
%      H = sirenshouru3 returns the handle to a new sirenshouru3 or the handle to
%      the existing singleton*.
%
%      sirenshouru3('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in sirenshouru3.M with the given input arguments.
%
%      sirenshouru3('Property','Value',...) creates a new sirenshouru3 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before sirenshouru3_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to sirenshouru3_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help sirenshouru3

% Last Modified by GUIDE v2.5 23-Sep-2020 10:59:27

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @sirenshouru3_OpeningFcn, ...
                   'gui_OutputFcn',  @sirenshouru3_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before sirenshouru3 is made visible.
function sirenshouru3_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to sirenshouru3 (see VARARGIN)

% Choose default command line output for sirenshouru3
set(gcf,'numbertitle','off','name','广告收入');
...
% UIWAIT makes sirenshouru3 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = sirenshouru3_OutputFcn(hObject, eventdata, handles) 

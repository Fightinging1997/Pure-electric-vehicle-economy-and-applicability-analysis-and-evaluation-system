function varargout = sirenshouru4(varargin)
% sirenshouru4 MATLAB code for sirenshouru4.fig
%      sirenshouru4, by itself, creates a new sirenshouru4 or raises the existing
%      singleton*.
%
%      H = sirenshouru4 returns the handle to a new sirenshouru4 or the handle to
%      the existing singleton*.
%
%      sirenshouru4('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in sirenshouru4.M with the given input arguments.
%
%      sirenshouru4('Property','Value',...) creates a new sirenshouru4 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before sirenshouru4_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to sirenshouru4_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help sirenshouru4

% Last Modified by GUIDE v2.5 02-May-2020 09:13:35

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @sirenshouru4_OpeningFcn, ...
                   'gui_OutputFcn',  @sirenshouru4_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before sirenshouru4 is made visible.
function sirenshouru4_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to sirenshouru4 (see VARARGIN)

% Choose default command line output for sirenshouru4
set(gcf,'numbertitle','off','name','充电桩对外收入');
...
% UIWAIT makes sirenshouru4 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = sirenshouru4_OutputFcn(hObject, eventdata, handles) 
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
set(handles.edit1,'string','20000');
set(handles.edit2,'string','20000');
set(handles.edit3,'string','20000');
set(handles.edit4,'string','20000');
set(handles.edit5,'string','20000');
set(handles.edit6,'string','20000');
set(handles.edit7,'string','20000');
set(handles.edit8,'string','20000');
set(handles.edit9,'string','20000');
set(handles.edit10,'string','20000');
set(handles.edit11,'string','20000');
set(handles.edit12,'string','20000');
set(handles.edit13,'string','20000');
set(handles.edit14,'string','20000');
set(handles.edit15,'string','20000');
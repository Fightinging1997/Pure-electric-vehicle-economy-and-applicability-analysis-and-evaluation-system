function varargout = chuzu4(varargin)
% chuzu4 MATLAB code for chuzu4.fig
%      chuzu4, by itself, creates a new chuzu4 or raises the existing
%      singleton*.
%
%      H = chuzu4 returns the handle to a new chuzu4 or the handle to
%      the existing singleton*.
%
%      chuzu4('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in chuzu4.M with the given input arguments.
%
%      chuzu4('Property','Value',...) creates a new chuzu4 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before chuzu4_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to chuzu4_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help chuzu4

% Last Modified by GUIDE v2.5 03-May-2020 20:55:40

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @chuzu4_OpeningFcn, ...
                   'gui_OutputFcn',  @chuzu4_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before chuzu4 is made visible.
function chuzu4_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to chuzu4 (see VARARGIN)
set(gcf,'numbertitle','off','name','保险费用和车船税');
% Choose default command line output for chuzu4
...
% UIWAIT makes chuzu4 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = chuzu4_OutputFcn(hObject, eventdata, handles) 

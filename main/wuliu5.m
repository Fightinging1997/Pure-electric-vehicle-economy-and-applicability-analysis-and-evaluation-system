function varargout = wuliu5(varargin)
% wuliu5 MATLAB code for wuliu5.fig
%      wuliu5, by itself, creates a new wuliu5 or raises the existing
%      singleton*.
%
%      H = wuliu5 returns the handle to a new wuliu5 or the handle to
%      the existing singleton*.
%
%      wuliu5('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in wuliu5.M with the given input arguments.
%
%      wuliu5('Property','Value',...) creates a new wuliu5 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before wuliu5_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to wuliu5_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help wuliu5

% Last Modified by GUIDE v2.5 02-May-2020 10:12:00

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @wuliu5_OpeningFcn, ...
                   'gui_OutputFcn',  @wuliu5_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before wuliu5 is made visible.
function wuliu5_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to wuliu5 (see VARARGIN)

set(gcf,'numbertitle','off','name','维修和保养费用');
% Choose default command line output for wuliu5
...
% UIWAIT makes wuliu5 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = wuliu5_OutputFcn(hObject, eventdata, handles) 

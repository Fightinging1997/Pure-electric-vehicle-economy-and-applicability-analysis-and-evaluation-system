function varargout = fenshi5(varargin)
% fenshi5 MATLAB code for fenshi5.fig
%      fenshi5, by itself, creates a new fenshi5 or raises the existing
%      singleton*.
%
%      H = fenshi5 returns the handle to a new fenshi5 or the handle to
%      the existing singleton*.
%
%      fenshi5('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in fenshi5.M with the given input arguments.
%
%      fenshi5('Property','Value',...) creates a new fenshi5 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before fenshi5_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to fenshi5_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help fenshi5

% Last Modified by GUIDE v2.5 03-May-2020 20:55:24

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @fenshi5_OpeningFcn, ...
                   'gui_OutputFcn',  @fenshi5_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before fenshi5 is made visible.
function fenshi5_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to fenshi5 (see VARARGIN)

set(gcf,'numbertitle','off','name','维修和保养费用');
% Choose default command line output for fenshi5
...
% UIWAIT makes fenshi5 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = fenshi5_OutputFcn(hObject, eventdata, handles) 
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
set(handles.edit1,'string','5500');
set(handles.edit2,'string','5500');
set(handles.edit3,'string','5500');
set(handles.edit4,'string','5500');
set(handles.edit5,'string','5500');
set(handles.edit6,'string','5500');
set(handles.edit7,'string','5500');
set(handles.edit8,'string','5500');
set(handles.edit9,'string','5500');
set(handles.edit10,'string','5500');
set(handles.edit11,'string','5500');
set(handles.edit12,'string','5500');
set(handles.edit13,'string','5500');
set(handles.edit14,'string','5500');
set(handles.edit15,'string','5500');

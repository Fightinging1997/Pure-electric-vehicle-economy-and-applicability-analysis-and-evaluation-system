function varargout = chuzu9(varargin)
% chuzu9 MATLAB code for chuzu9.fig
%      chuzu9, by itself, creates a new chuzu9 or raises the existing
%      singleton*.
%
%      H = chuzu9 returns the handle to a new chuzu9 or the handle to
%      the existing singleton*.
%
%      chuzu9('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in chuzu9.M with the given input arguments.
%
%      chuzu9('Property','Value',...) creates a new chuzu9 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before chuzu9_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to chuzu9_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help chuzu9

% Last Modified by GUIDE v2.5 03-May-2020 21:05:43

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @chuzu9_OpeningFcn, ...
                   'gui_OutputFcn',  @chuzu9_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before chuzu9 is made visible.
function chuzu9_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to chuzu9 (see VARARGIN)

% Choose default command line output for chuzu9
set(gcf,'numbertitle','off','name','年检费');
...
% UIWAIT makes chuzu9 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = chuzu9_OutputFcn(hObject, eventdata, handles) 

function ElecCon = EnergyConsumption_ht(m, k, h, n1, n2, n3)
...
for i=343:1330
    %计算发动机效率
    %1秒内的能耗
    Ed=(m*a(i)*v(i)*delt_t+u*m*g*v(i)*delt_t+0.5*A*Cd*p*a(i)*(v(i)^3)*delt_t)/(y_battery*0.85)+AccessoryPower*delt_t;

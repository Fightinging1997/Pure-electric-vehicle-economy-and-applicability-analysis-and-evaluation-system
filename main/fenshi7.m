function varargout = fenshi7(varargin)
% fenshi7 MATLAB code for fenshi7.fig
%      fenshi7, by itself, creates a new fenshi7 or raises the existing
%      singleton*.
%
%      H = fenshi7 returns the handle to a new fenshi7 or the handle to
%      the existing singleton*.
%
%      fenshi7('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in fenshi7.M with the given input arguments.
%
%      fenshi7('Property','Value',...) creates a new fenshi7 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before fenshi7_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to fenshi7_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help fenshi7

% Last Modified by GUIDE v2.5 02-May-2020 10:13:36

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @fenshi7_OpeningFcn, ...
                   'gui_OutputFcn',  @fenshi7_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before fenshi7 is made visible.
function fenshi7_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to fenshi7 (see VARARGIN)
set(gcf,'numbertitle','off','name','充电桩维护和运营费用');
% Choose default command line output for fenshi7
...
% UIWAIT makes fenshi7 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = fenshi7_OutputFcn(hObject, eventdata, handles) 

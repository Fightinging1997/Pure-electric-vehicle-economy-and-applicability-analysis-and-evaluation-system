function varargout = sirenshouru1(varargin)
% sirenshouru1 MATLAB code for sirenshouru1.fig
%      sirenshouru1, by itself, creates a new sirenshouru1 or raises the existing
%      singleton*.
%
%      H = sirenshouru1 returns the handle to a new sirenshouru1 or the handle to
%      the existing singleton*.
%
%      sirenshouru1('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in sirenshouru1.M with the given input arguments.
%
%      sirenshouru1('Property','Value',...) creates a new sirenshouru1 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before sirenshouru1_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to sirenshouru1_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help sirenshouru1

% Last Modified by GUIDE v2.5 12-May-2020 09:13:00

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @sirenshouru1_OpeningFcn, ...
                   'gui_OutputFcn',  @sirenshouru1_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before sirenshouru1 is made visible.
function sirenshouru1_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to sirenshouru1 (see VARARGIN)

% Choose default command line output for sirenshouru1
set(gcf,'numbertitle','off','name','主营业务收入');
...
% UIWAIT makes sirenshouru1 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = sirenshouru1_OutputFcn(hObject, eventdata, handles) 
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
set(handles.edit1,'string','50000');
set(handles.edit2,'string','50000');
set(handles.edit3,'string','50000');
set(handles.edit4,'string','50000');
set(handles.edit5,'string','50000');
set(handles.edit6,'string','50000');
set(handles.edit7,'string','50000');
set(handles.edit8,'string','50000');
set(handles.edit9,'string','50000');
set(handles.edit10,'string','50000');
set(handles.edit11,'string','50000');
set(handles.edit12,'string','50000');
set(handles.edit13,'string','50000');
set(handles.edit14,'string','50000');
set(handles.edit15,'string','50000');

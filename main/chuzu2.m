function varargout = chuzu2(varargin)
% chuzu2 MATLAB code for chuzu2.fig
%      chuzu2, by itself, creates a new chuzu2 or raises the existing
%      singleton*.
%
%      H = chuzu2 returns the handle to a new chuzu2 or the handle to
%      the existing singleton*.
%
%      chuzu2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in chuzu2.M with the given input arguments.
%
%      chuzu2('Property','Value',...) creates a new chuzu2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before chuzu2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to chuzu2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help chuzu2

% Last Modified by GUIDE v2.5 26-Apr-2020 12:30:38

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @chuzu2_OpeningFcn, ...
                   'gui_OutputFcn',  @chuzu2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before chuzu2 is made visible.
function chuzu2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to chuzu2 (see VARARGIN)

% Choose default command line output for chuzu2
...
% UIWAIT makes chuzu2 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = chuzu2_OutputFcn(hObject, eventdata, handles) 

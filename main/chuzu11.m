function varargout = chuzu11(varargin)
% chuzu11 MATLAB code for chuzu11.fig
%      chuzu11, by itself, creates a new chuzu11 or raises the existing
%      singleton*.
%
%      H = chuzu11 returns the handle to a new chuzu11 or the handle to
%      the existing singleton*.
%
%      chuzu11('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in chuzu11.M with the given input arguments.
%
%      chuzu11('Property','Value',...) creates a new chuzu11 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before chuzu11_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to chuzu11_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help chuzu11

% Last Modified by GUIDE v2.5 03-May-2020 21:06:42

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @chuzu11_OpeningFcn, ...
                   'gui_OutputFcn',  @chuzu11_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before chuzu11 is made visible.
function chuzu11_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to chuzu11 (see VARARGIN)

% Choose default command line output for chuzu11
...
% UIWAIT makes chuzu11 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = chuzu11_OutputFcn(hObject, eventdata, handles) 

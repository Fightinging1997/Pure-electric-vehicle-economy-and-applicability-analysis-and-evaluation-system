function varargout = cost3(varargin)
% cost3 MATLAB code for cost3.fig
%      cost3, by itself, creates a new cost3 or raises the existing
%      singleton*.
%
%      H = cost3 returns the handle to a new cost3 or the handle to
%      the existing singleton*.
%
%      cost3('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in cost3.M with the given input arguments.
%
%      cost3('Property','Value',...) creates a new cost3 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before cost3_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to cost3_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help cost3

% Last Modified by GUIDE v2.5 02-May-2020 12:45:06

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @cost3_OpeningFcn, ...
                   'gui_OutputFcn',  @cost3_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before cost3 is made visible.
function cost3_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to cost3 (see VARARGIN)

% Choose default command line output for cost3
set(gcf,'numbertitle','off','name','保养费用');
...
% UIWAIT makes cost3 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = cost3_OutputFcn(hObject, eventdata, handles) 
...
set(handles.edit2,'string','700');
set(handles.edit3,'string','700');
set(handles.edit4,'string','700');
set(handles.edit5,'string','700');
set(handles.edit6,'string','700');
set(handles.edit7,'string','700');
set(handles.edit8,'string','700');
set(handles.edit9,'string','700');
set(handles.edit10,'string','700');
set(handles.edit11,'string','700');
set(handles.edit12,'string','700');
set(handles.edit13,'string','700');
set(handles.edit14,'string','700');
set(handles.edit15,'string','700');
function varargout = fenshi2(varargin)
% fenshi2 MATLAB code for fenshi2.fig
%      fenshi2, by itself, creates a new fenshi2 or raises the existing
%      singleton*.
%
%      H = fenshi2 returns the handle to a new fenshi2 or the handle to
%      the existing singleton*.
%
%      fenshi2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in fenshi2.M with the given input arguments.
%
%      fenshi2('Property','Value',...) creates a new fenshi2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before fenshi2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to fenshi2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help fenshi2

% Last Modified by GUIDE v2.5 03-May-2020 20:49:46

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @fenshi2_OpeningFcn, ...
                   'gui_OutputFcn',  @fenshi2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before fenshi2 is made visible.
function fenshi2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to fenshi2 (see VARARGIN)

% Choose default command line output for fenshi2
set(gcf,'numbertitle','off','name','操作系统费用');
...
% UIWAIT makes fenshi2 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = fenshi2_OutputFcn(hObject, eventdata, handles) 
...
set(handles.edit5,'string','10000');
set(handles.edit6,'string','10000');
set(handles.edit7,'string','10000');
set(handles.edit8,'string','10000');
set(handles.edit9,'string','10000');
set(handles.edit10,'string','10000');
set(handles.edit11,'string','10000');
set(handles.edit12,'string','10000');
set(handles.edit13,'string','10000');
set(handles.edit14,'string','10000');
set(handles.edit15,'string','10000');

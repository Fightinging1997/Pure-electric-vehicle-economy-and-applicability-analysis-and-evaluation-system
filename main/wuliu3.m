function varargout = wuliu3(varargin)
% wuliu3 MATLAB code for wuliu3.fig
%      wuliu3, by itself, creates a new wuliu3 or raises the existing
%      singleton*.
%
%      H = wuliu3 returns the handle to a new wuliu3 or the handle to
%      the existing singleton*.
%
%      wuliu3('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in wuliu3.M with the given input arguments.
%
%      wuliu3('Property','Value',...) creates a new wuliu3 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before wuliu3_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to wuliu3_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help wuliu3

% Last Modified by GUIDE v2.5 02-May-2020 10:10:11

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @wuliu3_OpeningFcn, ...
                   'gui_OutputFcn',  @wuliu3_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before wuliu3 is made visible.
function wuliu3_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to wuliu3 (see VARARGIN)

% Choose default command line output for wuliu3
...
% UIWAIT makes wuliu3 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = wuliu3_OutputFcn(hObject, eventdata, handles) 

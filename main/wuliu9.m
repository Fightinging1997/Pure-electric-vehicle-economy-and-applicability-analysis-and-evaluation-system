function varargout = wuliu9(varargin)
% wuliu9 MATLAB code for wuliu9.fig
%      wuliu9, by itself, creates a new wuliu9 or raises the existing
%      singleton*.
%
%      H = wuliu9 returns the handle to a new wuliu9 or the handle to
%      the existing singleton*.
%
%      wuliu9('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in wuliu9.M with the given input arguments.
%
%      wuliu9('Property','Value',...) creates a new wuliu9 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before wuliu9_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to wuliu9_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help wuliu9

% Last Modified by GUIDE v2.5 03-May-2020 21:06:28

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @wuliu9_OpeningFcn, ...
                   'gui_OutputFcn',  @wuliu9_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before wuliu9 is made visible.
function wuliu9_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to wuliu9 (see VARARGIN)

% Choose default command line output for wuliu9
...
% UIWAIT makes wuliu9 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = wuliu9_OutputFcn(hObject, eventdata, handles) 

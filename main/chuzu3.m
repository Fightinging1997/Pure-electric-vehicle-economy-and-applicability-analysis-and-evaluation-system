function varargout = chuzu3(varargin)
% chuzu3 MATLAB code for chuzu3.fig
%      chuzu3, by itself, creates a new chuzu3 or raises the existing
%      singleton*.
%
%      H = chuzu3 returns the handle to a new chuzu3 or the handle to
%      the existing singleton*.
%
%      chuzu3('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in chuzu3.M with the given input arguments.
%
%      chuzu3('Property','Value',...) creates a new chuzu3 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before chuzu3_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to chuzu3_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help chuzu3

% Last Modified by GUIDE v2.5 01-May-2020 23:30:05

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @chuzu3_OpeningFcn, ...
                   'gui_OutputFcn',  @chuzu3_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before chuzu3 is made visible.
function chuzu3_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to chuzu3 (see VARARGIN)

% Choose default command line output for chuzu3
...
% UIWAIT makes chuzu3 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = chuzu3_OutputFcn(hObject, eventdata, handles) 

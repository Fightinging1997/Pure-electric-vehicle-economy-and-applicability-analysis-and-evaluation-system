function varargout = fenshi3(varargin)
% fenshi3 MATLAB code for fenshi3.fig
%      fenshi3, by itself, creates a new fenshi3 or raises the existing
%      singleton*.
%
%      H = fenshi3 returns the handle to a new fenshi3 or the handle to
%      the existing singleton*.
%
%      fenshi3('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in fenshi3.M with the given input arguments.
%
%      fenshi3('Property','Value',...) creates a new fenshi3 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before fenshi3_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to fenshi3_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help fenshi3

% Last Modified by GUIDE v2.5 03-May-2020 20:50:59

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @fenshi3_OpeningFcn, ...
                   'gui_OutputFcn',  @fenshi3_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before fenshi3 is made visible.
function fenshi3_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to fenshi3 (see VARARGIN)

% Choose default command line output for fenshi3
set(gcf,'numbertitle','off','name','人力资源费用');
...
% UIWAIT makes fenshi3 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = fenshi3_OutputFcn(hObject, eventdata, handles) 
...
set(handles.edit2,'string','5000');
set(handles.edit3,'string','5000');
set(handles.edit4,'string','5000');
set(handles.edit5,'string','5000');
set(handles.edit6,'string','5000');
set(handles.edit7,'string','5000');
set(handles.edit8,'string','5000');
set(handles.edit9,'string','5000');
set(handles.edit10,'string','5000');
set(handles.edit11,'string','5000');
set(handles.edit12,'string','5000');
set(handles.edit13,'string','5000');
set(handles.edit14,'string','5000');
set(handles.edit15,'string','5000');

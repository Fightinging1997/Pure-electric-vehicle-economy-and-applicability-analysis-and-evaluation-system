function varargout = chuzu7(varargin)
% chuzu7 MATLAB code for chuzu7.fig
%      chuzu7, by itself, creates a new chuzu7 or raises the existing
%      singleton*.
%
%      H = chuzu7 returns the handle to a new chuzu7 or the handle to
%      the existing singleton*.
%
%      chuzu7('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in chuzu7.M with the given input arguments.
%
%      chuzu7('Property','Value',...) creates a new chuzu7 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before chuzu7_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to chuzu7_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help chuzu7

% Last Modified by GUIDE v2.5 01-May-2020 23:39:36

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @chuzu7_OpeningFcn, ...
                   'gui_OutputFcn',  @chuzu7_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before chuzu7 is made visible.
function chuzu7_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to chuzu7 (see VARARGIN)
set(gcf,'numbertitle','off','name','充电桩维护和运营费用');
% Choose default command line output for chuzu7
...
% UIWAIT makes chuzu7 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = chuzu7_OutputFcn(hObject, eventdata, handles) 

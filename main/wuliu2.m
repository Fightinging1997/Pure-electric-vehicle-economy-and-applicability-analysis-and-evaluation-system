function varargout = wuliu2(varargin)
% wuliu2 MATLAB code for wuliu2.fig
%      wuliu2, by itself, creates a new wuliu2 or raises the existing
%      singleton*.
%
%      H = wuliu2 returns the handle to a new wuliu2 or the handle to
%      the existing singleton*.
%
%      wuliu2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in wuliu2.M with the given input arguments.
%
%      wuliu2('Property','Value',...) creates a new wuliu2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before wuliu2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to wuliu2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help wuliu2

% Last Modified by GUIDE v2.5 02-May-2020 10:07:55

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @wuliu2_OpeningFcn, ...
                   'gui_OutputFcn',  @wuliu2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before wuliu2 is made visible.
function wuliu2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to wuliu2 (see VARARGIN)

% Choose default command line output for wuliu2
...
% UIWAIT makes wuliu2 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = wuliu2_OutputFcn(hObject, eventdata, handles) 

function varargout = wuliu7(varargin)
% wuliu7 MATLAB code for wuliu7.fig
%      wuliu7, by itself, creates a new wuliu7 or raises the existing
%      singleton*.
%
%      H = wuliu7 returns the handle to a new wuliu7 or the handle to
%      the existing singleton*.
%
%      wuliu7('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in wuliu7.M with the given input arguments.
%
%      wuliu7('Property','Value',...) creates a new wuliu7 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before wuliu7_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to wuliu7_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help wuliu7

% Last Modified by GUIDE v2.5 12-May-2020 09:18:04

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @wuliu7_OpeningFcn, ...
                   'gui_OutputFcn',  @wuliu7_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before wuliu7 is made visible.
function wuliu7_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to wuliu7 (see VARARGIN)
set(gcf,'numbertitle','off','name','充电桩维护和运营费用');
% Choose default command line output for wuliu7
...
% UIWAIT makes wuliu7 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = wuliu7_OutputFcn(hObject, eventdata, handles) 

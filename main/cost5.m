function varargout = cost5(varargin)
% cost5 MATLAB code for cost5.fig
%      cost5, by itself, creates a new cost5 or raises the existing
%      singleton*.
%
%      H = cost5 returns the handle to a new cost5 or the handle to
%      the existing singleton*.
%
%      cost5('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in cost5.M with the given input arguments.
%
%      cost5('Property','Value',...) creates a new cost5 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before cost5_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to cost5_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help cost5

% Last Modified by GUIDE v2.5 02-May-2020 12:46:41

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @cost5_OpeningFcn, ...
                   'gui_OutputFcn',  @cost5_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before cost5 is made visible.
function cost5_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to cost5 (see VARARGIN)

set(gcf,'numbertitle','off','name','Œ¨–ﬁ∑—”√');
% Choose default command line output for cost5
...
% UIWAIT makes cost5 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = cost5_OutputFcn(hObject, eventdata, handles) 
...
set(handles.edit3,'string','2000');
set(handles.edit4,'string','2000');
set(handles.edit5,'string','2000');
set(handles.edit6,'string','2000');
set(handles.edit7,'string','2000');
set(handles.edit8,'string','2000');
set(handles.edit9,'string','2000');
set(handles.edit10,'string','2000');
set(handles.edit11,'string','2000');
set(handles.edit12,'string','2000');
set(handles.edit13,'string','2000');
set(handles.edit14,'string','2000');
set(handles.edit15,'string','2000');
function varargout = wuliu4(varargin)
% wuliu4 MATLAB code for wuliu4.fig
%      wuliu4, by itself, creates a new wuliu4 or raises the existing
%      singleton*.
%
%      H = wuliu4 returns the handle to a new wuliu4 or the handle to
%      the existing singleton*.
%
%      wuliu4('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in wuliu4.M with the given input arguments.
%
%      wuliu4('Property','Value',...) creates a new wuliu4 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before wuliu4_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to wuliu4_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help wuliu4

% Last Modified by GUIDE v2.5 12-Jun-2020 09:23:52

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @wuliu4_OpeningFcn, ...
                   'gui_OutputFcn',  @wuliu4_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before wuliu4 is made visible.
function wuliu4_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to wuliu4 (see VARARGIN)
set(gcf,'numbertitle','off','name','保险费用和车船税');
% Choose default command line output for wuliu4
...
% UIWAIT makes wuliu4 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = wuliu4_OutputFcn(hObject, eventdata, handles) 

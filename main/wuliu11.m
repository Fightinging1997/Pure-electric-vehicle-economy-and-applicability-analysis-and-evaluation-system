function varargout = wuliu11(varargin)
% wuliu11 MATLAB code for wuliu11.fig
%      wuliu11, by itself, creates a new wuliu11 or raises the existing
%      singleton*.
%
%      H = wuliu11 returns the handle to a new wuliu11 or the handle to
%      the existing singleton*.
%
%      wuliu11('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in wuliu11.M with the given input arguments.
%
%      wuliu11('Property','Value',...) creates a new wuliu11 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before wuliu11_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to wuliu11_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help wuliu11

% Last Modified by GUIDE v2.5 19-Oct-2021 17:26:00

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @wuliu11_OpeningFcn, ...
                   'gui_OutputFcn',  @wuliu11_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before wuliu11 is made visible.
function wuliu11_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to wuliu11 (see VARARGIN)

% Choose default command line output for wuliu11
...
% UIWAIT makes wuliu11 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = wuliu11_OutputFcn(hObject, eventdata, handles) 
...
set(handles.edit4,'string','1000');
set(handles.edit5,'string','1000');
set(handles.edit6,'string','1000');
set(handles.edit7,'string','1000');
set(handles.edit8,'string','1000');
set(handles.edit9,'string','1000');
set(handles.edit10,'string','1000');
set(handles.edit11,'string','1000');
set(handles.edit12,'string','1000');
set(handles.edit13,'string','1000');
set(handles.edit14,'string','1000');
set(handles.edit15,'string','1000');

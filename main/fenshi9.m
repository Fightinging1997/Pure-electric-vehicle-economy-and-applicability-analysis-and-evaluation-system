function varargout = fenshi9(varargin)
% fenshi9 MATLAB code for fenshi9.fig
%      fenshi9, by itself, creates a new fenshi9 or raises the existing
%      singleton*.
%
%      H = fenshi9 returns the handle to a new fenshi9 or the handle to
%      the existing singleton*.
%
%      fenshi9('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in fenshi9.M with the given input arguments.
%
%      fenshi9('Property','Value',...) creates a new fenshi9 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before fenshi9_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to fenshi9_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help fenshi9

% Last Modified by GUIDE v2.5 12-Jun-2020 09:44:19

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @fenshi9_OpeningFcn, ...
                   'gui_OutputFcn',  @fenshi9_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before fenshi9 is made visible.
function fenshi9_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to fenshi9 (see VARARGIN)

% Choose default command line output for fenshi9
...
% UIWAIT makes fenshi9 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = fenshi9_OutputFcn(hObject, eventdata, handles) 

function varargout = fenshi4(varargin)
% fenshi4 MATLAB code for fenshi4.fig
%      fenshi4, by itself, creates a new fenshi4 or raises the existing
%      singleton*.
%
%      H = fenshi4 returns the handle to a new fenshi4 or the handle to
%      the existing singleton*.
%
%      fenshi4('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in fenshi4.M with the given input arguments.
%
%      fenshi4('Property','Value',...) creates a new fenshi4 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before fenshi4_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to fenshi4_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help fenshi4

% Last Modified by GUIDE v2.5 02-May-2020 10:10:56

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @fenshi4_OpeningFcn, ...
                   'gui_OutputFcn',  @fenshi4_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before fenshi4 is made visible.
function fenshi4_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to fenshi4 (see VARARGIN)
set(gcf,'numbertitle','off','name','保险费用和车船税');
% Choose default command line output for fenshi4
...
% UIWAIT makes fenshi4 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = fenshi4_OutputFcn(hObject, eventdata, handles) 
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
set(handles.edit1,'string','6658');
set(handles.edit2,'string','4660');
set(handles.edit3,'string','4660');
set(handles.edit4,'string','4660');
set(handles.edit5,'string','4660');
set(handles.edit6,'string','4660');
set(handles.edit7,'string','4660');
set(handles.edit8,'string','4660');
set(handles.edit9,'string','4660');
set(handles.edit10,'string','4660');
set(handles.edit11,'string','4660');
set(handles.edit12,'string','4660');
set(handles.edit13,'string','4660');
set(handles.edit14,'string','4660');
set(handles.edit15,'string','4660');

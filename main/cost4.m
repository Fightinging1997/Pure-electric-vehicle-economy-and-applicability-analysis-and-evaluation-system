function varargout = cost4(varargin)
% cost4 MATLAB code for cost4.fig
%      cost4, by itself, creates a new cost4 or raises the existing
%      singleton*.
%
%      H = cost4 returns the handle to a new cost4 or the handle to
%      the existing singleton*.
%
%      cost4('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in cost4.M with the given input arguments.
%
%      cost4('Property','Value',...) creates a new cost4 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before cost4_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to cost4_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help cost4

% Last Modified by GUIDE v2.5 12-Jun-2020 09:37:27

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @cost4_OpeningFcn, ...
                   'gui_OutputFcn',  @cost4_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before cost4 is made visible.
function cost4_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to cost4 (see VARARGIN)
set(gcf,'numbertitle','off','name','保险费用和车船税');
% Choose default command line output for cost4
...
% UIWAIT makes cost4 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = cost4_OutputFcn(hObject, eventdata, handles) 
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
set(handles.edit1,'string','8700');
set(handles.edit2,'string','8700');
set(handles.edit3,'string','8700');
set(handles.edit4,'string','8700');
set(handles.edit5,'string','8700');
set(handles.edit6,'string','8700');
set(handles.edit7,'string','8700');
set(handles.edit8,'string','8700');
set(handles.edit9,'string','8700');
set(handles.edit10,'string','8700');
set(handles.edit11,'string','8700');
set(handles.edit12,'string','8700');
set(handles.edit13,'string','8700');
set(handles.edit14,'string','8700');
set(handles.edit15,'string','8700');
